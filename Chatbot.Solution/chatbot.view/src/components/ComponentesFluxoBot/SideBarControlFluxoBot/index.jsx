...
export default function SidebarControlFluxoBot(props) {
    return (
        <div>
            <div className='header p-2' style={{ minHeight: "3.3rem" }}>
            ...
            <div className='w-100 p-2' >
                <h6 className='d-flex jusitfy-content-center align-items-center gap-2 textColorForFluxoBot' style={{ cursor: "pointer" }}>
