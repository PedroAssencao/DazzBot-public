import './style.css';
import { verificarRegrasSalvarOption, SelectTipoHandEvent } from '../../../Repository/FluxoBoxRepository'
...
export default function ModalDeAdicaoFluxoBot(props) {
    ...
    const selecionarDepartamentoAtivoNoSelect = (param) => {
        try {
            const selectElement = document.querySelector("#selectDepartamento");
    ...
    useEffect(() => {
        UsuarioLogado().then(result => {
            ...
            const containerPai = document.querySelector("#modalAddFluxoBot");
        ...
        <div className="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered modal-xl">
                <div className="modal-content">
                    <div className="modal-body" id='modalAddFluxoBot'>
                        ...
                        <div className="row mt-4" style={{ display: "none" }} id="RedirecionamentoInputsSections">
                            <div className="col-6 mb-3">
                                ...
                                <input maxLength={24} id="TituloOpcaoMenuInputRedirecionamento" placeholder="Obrigatorio"
                        ...
                        <div className="gap-3 justify-content-between mt-4 flex-column" style={{ display: "none" }}
                            ...
                            <div className="row">
                                <div className="col-6 mb-3">
                                    ...
                                    <input id="TituloSimplesInput" maxLength={24} placeholder="Obrigatorio" className="form-control" />
                                </div>
                                <div className="col-6 mb-3">
                        ...
                        {/* Caso A mensagem Seja do Tipo de IA*/}
                        <div className="gap-3 justify-content-between mt-4 flex-column" style={{ display: "none" }}
                            id="TextareaSelectIA">
                            <div className="row">
                                <div className="col-6 mb-3">
                                    <label className="mb-2"><strong>Titulo</strong></label>
                                    <input id="TituloSimplesInputIA" maxLength={24} placeholder="Obrigatorio" className="form-control" />
                                </div>
                                {/* <div className="col-6 mb-3">
                                    <label className="mb-2"><strong>Descricao</strong></label>
                                    <input id="DescricaoSimplesInput" placeholder="Obrigatorio" className="form-control" />
                            ...
                            <div className="w-100">
                                ...
                                <textarea style={{ minHeight: "10rem", resize: "none" }} id="textAreaContentIA"
                                    className="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div className="row mt-4" style={{ display: "none" }} id="MultiplaEscolha">
                            <div className="col-6 mb-3">
                                <label className="mb-2"><strong>Titulo da Opção</strong></label>
                                <input maxLength={24} id="TituloOpcaoMenuInput" placeholder="Obrigatorio" className="form-control" />
                            </div>
                            <div className="col-6 mb-3">
                                <label className="mb-2"><strong>Descrição</strong></label>
                    ...
                    <div className="modal-footer border-top-0">
                        ...
                        <ButtonBase
                            ...
                            Description={"Salvar"}
                            onClick={async () => {
                                console.log("Bateu no click de adiconar")
                                await verificarRegrasSalvarOption()
                                console.log("Passou re verificar regras salvar option")
