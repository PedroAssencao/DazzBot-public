...
insert into Atendimento (aten_estado,aten_data,ate_id,dep_id,con_id,log_id) values (null,GETDATE(),1,1,1,1)
insert into chat (ate_id, log_id, con_id, aten_id) values (1,1,1,1)
select * from login
